          ...
          <el-table :data="manyTableData" border stripe>
            ...
            <el-table-column label="操作">
              <template v-slot="scope">
                ...
                <el-button size="mini" type="danger" icon="el-icon-dellete" @click="removeParams(scope.row.attr_id)">删除</el-button>
              </template>
            </el-table-column>
          </el-table>
        </el-tab-pane>
  ...
  methods: {
    ...
    editParams() {
      this.$refs.editFormRef.validate(async valid => {
        ...
        console.log(111, this.activeName, this.editForm, res)
        if (res.meta.status !== 200) {
    ...
    showInput(row) {
      ...
      // 文本框自动聚焦 $nextTick：当页面上元素被重新渲染之后，才会执行回调函数中的代码
      this.$nextTick(() => {
